...
% if exist(fullfile(opts.resultDir,'re`sult.mat')),
...
if ~exist(opts.imdbPath)
 ...
 switch opts.dataset
   ...
   case 'Places', imdb = setupPlaces(opts.datasetDir, 'lite', opts.lite) ;
...
if ~exist(opts.encoderPath)
  ...
  train = vl_colsubset(find(imdb.images.set <= 2), numTrain, 'beginning') ;
